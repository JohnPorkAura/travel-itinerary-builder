...
DB_FILE      = "travel_itinerary_builder.db"
SYSTEM_PROMPT = "You are an expert Travel Itinerary Builder assistant. Tell us your destination, trip length, budget, and interests. Get a day-by-day itinerary with recommendations."

app = FastAPI(title="Travel Itinerary Builder")
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Travel Itinerary Builder</div>
    <div class="auth-sub">Plan your perfect trip in minutes</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Travel Itinerary Builder</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Travel Itinerary Builder</em><br>Plan your perfect trip in minutes</h1>
    <p>Tell us your destination, trip length, budget, and interests. Get a day-by-day itinerary with recommendations. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <textarea id="field-destination" placeholder="Enter destination..." required></textarea>
    </div>
    <div class="field">
      <label for="field-duration">Duration</label>
      <input type="text" id="field-duration" placeholder="e.g. your duration">
    </div>
    <div class="field">
      <label for="field-budget">Budget</label>
      <select id="field-budget">
  ...
  <footer>
    <div class="foot-note">Travel Itinerary Builder &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  inputs:         [{"id": "destination", "label": "Destination", "type": "textarea", "placeholder": "Enter destination...", "required": true}, {"id": "duration", "label": "Duration", "type": "text", "placeholder": "e.g. your duration", "required": false}, {"id": "budget", "label": "Budget", "type": "select", "options": ["Budget", "Mid-range", "Luxury", "No limit"], "required": false}, {"id": "interests", "label": "Interests", "type": "text", "placeholder": "e.g. your interests", "required": false}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Travel Itinerary Builder", "ai_ready": bool(GROQ_API_KEY)}
